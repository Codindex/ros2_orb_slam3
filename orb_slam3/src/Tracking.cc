...
Tracking::Tracking(System *pSys, ORBVocabulary* pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Atlas *pAtlas, KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor, Settings* settings, const string &_nameSeq):
    ...
    mbReadyToInitializate(false), mpSystem(pSys), mpViewer(NULL), mpFrameDrawer(pFrameDrawer), mpMapDrawer(pMapDrawer), bStepByStep(false),
    mpAtlas(pAtlas), mpLastKeyFrame(static_cast<KeyFrame*>(NULL)), mnLastRelocFrameId(0), time_recently_lost(5.0),
